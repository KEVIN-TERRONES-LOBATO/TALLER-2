...
map.getView().fit([-79.558630, -6.583512, -77.934531, -5.381765], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UNIDADES GEOLOGICAS DE CUTERVO</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (31 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@FRANKLIN KEVIN TERRONES LOBATO';
            }
